...
class RAGChainBuilder:
    ...
    def build_chain(self):
        ...
        7. ONLY use information from the provided CONTEXT below.
        8. If the context does not contain enough information to answer, say \
"I don't have enough information about that."
        9. NEVER make up product names, prices, features, or reviews.
        10. When mentioning prices, ratings, or sentiment, use exact values from context.
