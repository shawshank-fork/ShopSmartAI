## Sentiment Analysis pf product reviews using DistilBERT
...
class SentimentAnalyzer:
    ...
    def __init__(self):
        logger.info("Loading DsitilBERT sentiment model.")
    ...
    def analyze_reviews(self, reviews):
        """Analyze a list of review dicts from dummyjson, retunrs summary - +ve count, -ve count, avg score """
        if not reviews:
            return {
                "positive":0,
                "negative": 0,
        ...
        summary = "Mostly positive" if positive > negative else "Mostly negative" if negative > positive else "Mixed"
...
analyze_reviews(reviews) — takes the DummyJSON review list, classifies all of them, and returns a summary (positive count, negative count, average score, overall sentiment)
"""
